...
router.get("/", authMiddleware, ProductController.GetAllProducts); //bulk get products
router.get("/:id", authMiddleware, ProductController.getProductById); // show specific product
